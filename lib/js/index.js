(function (window, document) {
  ...
  function configInit() {
    ...
    var activeCalList = document.getElementById('calendars');
    var calList = document.getElementById('calendars');
    activeCalList.addEventListener('click', removeICS);
    calList.addEventListener('click', addICS);
    
    savedCals = localStorage.getItem('cals')
    sources = JSON.parse(savedCals) || {}
    console.log(sources)
